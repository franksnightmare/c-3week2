...
template <>
class Arithmetic<int>: public BinopsBase<Arithmetic<int>>
{
	...
	public:
		...
		void swap(Arithmetic<int> &other)
		{
			...
			std::memcpy(step, this, sizeof(Arithmetic<int>));
			std::memcpy(&other, step, sizeof(Arithmetic<int>));
			std::memcpy(this, &other, sizeof(Arithmetic<int>));
		}
...
template <>
class Arithmetic<double>: public BinopsBase<Arithmetic<double>>
{
	...
	public:
		...
		void swap(Arithmetic<double> &other)
		{
			...
			std::memcpy(step, this, sizeof(Arithmetic<double>));
			std::memcpy(&other, step, sizeof(Arithmetic<double>));
			std::memcpy(this, &other, sizeof(Arithmetic<double>));
		}
